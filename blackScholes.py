...
st.markdown("<h5 align='center'>Made by Gaurav Singh</h5>", unsafe_allow_html=True)
st.header("")
st.markdown("<h6>See project's description and assumptions here: <a href='https://github.com/gaurav13020/blackScholes'>https://github.com/gaurav13020/blackScholes</a></h6>", unsafe_allow_html=True)
st.markdown("<h6>See all my other projects here: <a href='https://github.com/gaurav13020'>https://github.com/gaurav13020</a></h6>", unsafe_allow_html=True)
st.header("")
